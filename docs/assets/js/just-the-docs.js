(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://siunami.github.io/thought-space/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://siunami.github.io/thought-space/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://siunami.github.io/thought-space/assets/css/just-the-docs-' + theme + ".css"
      );
    };
